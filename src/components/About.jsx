...
export default function About() {
  ...
  return (
    <div style={{marginLeft: "50vw", paddingBottom: "96px", paddingRight: "24px", width: "50vw", boxSizing: "border-box"}}>

        <p style={{fontSize: "2rem", marginBottom: "196px"}}>
          <h2 style={{display: "inline", fontSize: "1rem", marginRight: "48px", position: "relative", bottom: "10px", color: "#D3B703"}}>
            ABOUT ME
          </h2>
        ...
        <p style={{fontSize: "2rem", marginBottom: "196px"}}>
        <h2 style={{display: "inline", fontSize: "1rem", marginRight: "48px", position: "relative", bottom: "12px", color: "#D3B703"}}>ABOUT MY WORK</h2>
      ...
      {/* <p style={{fontSize: "3rem", marginBottom: "196px"}}>
        <TextReveal>
          <h2 style={{display: "inline", fontSize: "1rem", marginRight: "48px"}}>ABOUT ME</h2>
        ...
        <TextReveal>
          <p>Italo disco, arthouse films, and esoterica are some things that get me going. In a former life, I was a visual artist.</p>
        </TextReveal>
      </p>

      <p style={{fontSize: "3rem", marginBottom: "196px"}}>
        <TextReveal>
          <h2 style={{display: "inline", fontSize: "1rem", marginRight: "48px"}}>ABOUT MY WORK</h2>
        ...
        <TextReveal>
          <p>My writing also extends to print, film, and television. Currently, I’m a part of Granta Magazine’s inaugural Writing Memoir Workshop.</p>
        </TextReveal>
        <TextReveal>
          <p>I’m also a co-creator of the comedy series Oval, in development with Telepool Germany, Picture Perfect Federation, and Potboiler Productions.</p>
        </TextReveal>
      </p> */}
